                ...
                <ul id="side" class="nav navbar-nav side-nav">
                    ...
                    <li class="side-user hidden-xs">
                        ...
                        <p class="name tooltip-sidebar-logout">
                            ...
                            <span class="last-name">Smith</span> <a style="color: inherit" class="logout_open" href="admin/logout" data-toggle="tooltip" data-placement="top" title="Logout"><i class="fa fa-sign-out"></i></a>
                        </p>
